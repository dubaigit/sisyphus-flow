...
## 8. Claude-Flow Swarm State (include if cf_* tools were used)
- **Swarm Active**: Whether a swarm was running and its topology
- **Active Agents**: Spawned agents and their tasks
- **Memory Entries**: Keys/namespaces stored via \`cf_memory_store\`
- **Consensus Decisions**: Any consensus results and outcomes
- Use \`cf_memory_search\` to retrieve prior learnings before resuming.
`
